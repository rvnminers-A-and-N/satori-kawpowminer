...
#
# Testscript to test satori-kawpowminer multiple pools/hosts/syntaxes
# Put this script in the bin directory of satori-kawpowminer and start running
#
...
# export some vars as "./satori-kawpowminer" could be still a wrapper script
...
for pool in $POOLS; do
    ...
    echo "./satori-kawpowminer -v 1 --exit --report-hashrate -P $pool $@"
    echo "./satori-kawpowminer -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./satori-kawpowminer -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
